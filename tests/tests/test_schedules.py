...
def test_find_switchpoints() -> None:
    ...
    assert _find_switchpoints(schedule, TccDayOfWeek.TUESDAY, "07:59:59") == (
    ...
    assert _find_switchpoints(schedule, TccDayOfWeek.TUESDAY, "08:00:00") == (
        {"heat_setpoint": 18.2, "time_of_day": "08:00:00"},
        0,
    ...
    assert _find_switchpoints(schedule, TccDayOfWeek.TUESDAY, "08:00:01") == (
        {"heat_setpoint": 18.2, "time_of_day": "08:00:00"},
        0,
        {"heat_setpoint": 19.3, "time_of_day": "17:00:00"},
        0,
    ...
    assert _find_switchpoints(schedule, TccDayOfWeek.SUNDAY, "23:59:59") == (
        {"heat_setpoint": 14.8, "time_of_day": "21:30:00"},
        0,
        {"heat_setpoint": 23.2, "time_of_day": "06:30:00"},
        1,
...
def test_find_switchpoints_empty_schedule() -> None:
    ...
    with pytest.raises(exc.InvalidScheduleError, match="daily schedules are empty"):
        _find_switchpoints([], TccDayOfWeek.MONDAY, "08:00:00")
...
def test_dt_to_dow_and_tod(
    ...
    assert dow in TccDayOfWeek  # always a valid enum member
