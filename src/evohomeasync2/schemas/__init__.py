...
The API is undocumented, so the TypedDicts defined across the submodules of this
...
purpose: runtime validation and coercion of the data returned by the API.
...
# for convenience...
def factory_get_schedule(_: Callable[[str], str] = noop) -> vol.Schema:
